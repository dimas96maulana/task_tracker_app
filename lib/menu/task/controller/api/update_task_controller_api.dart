...
import '../../service/api/update_task_service_api.dart';

class UpdateTaskControllerApi implements VariabelController{
  final UpdateTaskServiceApi updateTaskServiceApi = UpdateTaskServiceApi();
  ...
  Future send({required String id, required Map<String, dynamic> params}) async {
    refreshVariabel();
    
    result = await updateTaskServiceApi.send(
      id: id,
      params: params
    );
