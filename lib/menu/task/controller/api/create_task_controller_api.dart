...
import '../../service/api/create_task_service_api.dart';

class CreateTaskControllerApi implements VariabelController{
  final CreateTaskServiceApi createTaskServiceApi = CreateTaskServiceApi();
  ...
  Future send({required Map<String, dynamic> params}) async {
    refreshVariabel();
    
    result = await createTaskServiceApi.send(
      params: params
    );
